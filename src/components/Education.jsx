          ...
          <div className='relative'>
            ...
            {educationData.map((edu, index) => (
              <div key={index} className={`relative flex items-center mb-12 ${index % 2 === 0 ? 'justify-start' : 'justify-end'}`}>
                {/* Timeline Dot */}
                <div className='absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-white border-4 border-neutral-100 dark:border-white/10 rounded-full z-10'></div>
          ...
          <div className='relative'>
            ...
            {educationData.map((edu, index) => (
              <div key={index} className='relative flex items-start mb-8 pl-16'>
                {/* Timeline Dot */}
                <div className='absolute left-4 top-6 w-4 h-4 bg-white border-4 border-neutral-100 dark:border-white/10 rounded-full z-10'></div>
